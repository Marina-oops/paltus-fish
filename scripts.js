const PRODUCTS = [
    ...
    {
      id: 33,
      name: "Жиллет спасательный Freeway",
      price: 1800,
      ...
      description: [
        "Жиллет спасательный с четырьмя накладными карманами,со светоотражающими нашивками.",
        "Воротник отстегивается, внутренности вынимаются, для стирки и для того, чтобы его можно было носить, как жиллет-разгрузку!"
      ],
    ...
    {
      id: 62,
      name: "Кресло круглое Palisad Camping 85х46х85см",
      price: 3905,
      image: "images/creslo.jpg",
      images: [
        "images/creslo.jpg"
      ],
      description: [
        "Круглое кресло Palisad Camping для отдыха на природе, рыбалке и даче.",
        "Усиленный стальной каркас (22мм) выдерживает до 100 кг. Износостойкий полиэстер (600D) устойчив к влаге и УФ-лучам. Компактно складывается для удобной транспортировки."
      ],
